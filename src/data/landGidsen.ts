...
const landGidsen: LandData[] = [
  {
    ...
    bedrijfOprichten: {
      ...
      punten: [
        "SARL (Société à Responsabilité Limitée = Marokkaanse BV): sinds wet 24-10 geen wettelijk minimumkapitaal meer. Storting op een geblokkeerde rekening is pas verplicht boven MAD 100.000 kapitaal. Minstens een kwart van de aandelen bij oprichting volstorten, de rest binnen 5 jaar. Registratie bij Tribunal de Commerce. Tijdsduur: 7 tot 15 werkdagen via het CRI-loket",
        "SASU (vereenvoudigde eenpersoons-SARL): voor eenmanszaak, zelfde procedure, geen minimumkapitaal vereist. Let op: juridisch mag MAD 1, maar uw kapitaal staat in het openbare handelsregister en banken en verhuurders kijken ernaar",
        "Casablanca Finance City (CFC): speciaal statuut voor internationale holding- en dienstbedrijven. Let op, veel bronnen zijn hier verouderd: het CFC-tarief is meegegaan in de convergentie en staat sinds 2026 op 20 procent, niet meer op 15 procent. Wel: 5 jaar volledige vrijstelling op exportomzet, en vrijstelling van bronheffing op dividend aan niet-ingezeten aandeelhouders. Vereisten zijn zwaar (fysiek hoofdkantoor in CFC, een in Marokko wonende bestuurder, een senior executive met internationale ervaring) en de lidmaatschapskosten zijn niet openbaar",
        "Zones d'accélération industrielle (voorheen vrije zones, o.a. Tanger MedPort en Kénitra): 5 jaar volledige vrijstelling vennootschapsbelasting, daarna 20 procent sinds 2026 (het oude 8,75 procent geldt alleen nog voor bedrijven gevestigd vóór 1 januari 2021). Ideaal voor productie en export",
        "Vennootschapsbelasting (IS) in 2026: 20 procent bij een nettowinst onder MAD 100 miljoen, 35 procent daarboven, 40 procent voor banken en verzekeraars. Let op de klif: het tarief geldt over de hele winst, niet per schijf",
        "Minimumbijdrage (cotisation minimale): 0,25 procent van de omzet, met een bodem van MAD 3.000, ook in verliesjaren. De eerste 36 maanden na start bent u vrijgesteld, waardoor veel ondernemers dit pas in jaar 4 ontdekken",
        "Deviezen, de duurste stille fout: uw recht om winst en kapitaal later naar Nederland te repatriëren hangt af van hoe u het geld inbrengt. Breng kapitaal in via de erkende deviezenroute en laat de investering registreren bij de Office des Changes. Wie informeel of in dirham inbrengt, krijgt het er later niet meer uit. Deze fout is niet achteraf te herstellen",
...

  {
    ...
    belasting: {
      ...
      punten: [
        ...
        "Free Zone en het 0-procenttarief, lees dit voordat u kiest: 0 procent geldt alleen voor kwalificerend inkomen uit een vaste lijst activiteiten (onder meer productie, verwerking, grondstoffenhandel, houdsteractiviteiten, scheepvaart, fondsbeheer, logistiek). Advies, consultancy, marketing en dienstverlening aan derden staan NIET op die lijst. Wie daarboven uitkomt (meer dan 5 procent van de omzet of AED 5 miljoen, de laagste van beide) verliest de status niet gedeeltelijk maar volledig, op het hele inkomen, voor het lopende jaar plus vier jaar daarna",
        "Free Zone verplichting die zelden wordt genoemd: voor de 0-procentstatus is een gecontroleerde IFRS-jaarrekening verplicht. Die accountantskost zit in geen enkel instappakket",
        "Small Business Relief (vrijstelling tot AED 3 miljoen omzet) loopt af op 31 december 2026. Bouw uw businessplan niet op deze regeling zonder een scenario voor 2027",
        "BTW: 5 procent, een van de laagste ter wereld. Verplicht boven AED 375.000 omzet per jaar. Let op: voor niet-ingezeten ondernemingen geldt geen drempel",
        "Nederland-VAE belastingverdrag: dit BESTAAT wel degelijk, getekend in 2007. Veel bronnen beweren het tegendeel. Belangrijker is de andere kant: een VAE-vennootschap die feitelijk vanuit Nederland wordt bestuurd kan gewoon Nederlands belastingplichtig zijn, ongeacht de inschrijving in Dubai. De plaats van de feitelijke leiding is doorslaggevend, niet het adres op het briefpapier",
    ...
    bedrijfOprichten: {
      ...
      punten: [
        ...
        "Mainland LLC: de eis van 51 procent Emiratisch eigendom is AFGESCHAFT. Sinds Federal Decree-Law 26 van 2020 en de nieuwe vennootschapswet (Federal Decree-Law 32 van 2021) is 100 procent buitenlands eigendom de hoofdregel. Uitgezonderd blijven activiteiten met strategische impact (defensie, bankwezen, verzekeringen, telecom en enkele andere). Let op de nuance: de emiraten houden eigen positieve lijsten per activiteit, dus of uw specifieke activiteitscode 100 procent toestaat is een vraag per emiraat en per activiteit",
        "Belangrijk, wij adviseren geen stromanconstructies. Nu 100 procent eigendom rechtstreeks kan, is een nominee-arrangement onnodig en juridisch kwetsbaar. Voor professionele eenmanszaken en civil companies geldt in Dubai in de praktijk nog wel een Local Service Agent, die geen aandelen, geen winstdeel en geen bestuursbevoegdheid heeft",
        "Sinds maart 2025 mag een Dubai free zone-bedrijf onder voorwaarden ook op het mainland opereren (Executive Council Resolution 11 van 2025): filiaalvergunning AED 10.000 per jaar of tijdelijke vergunning AED 5.000, met goedkeuring van DET en de free zone-autoriteit en een gescheiden administratie. Op die onshore-omzet geldt wel het normale tarief van 9 procent",
        "Oprichtingstijd: 1 tot 3 weken voor Free Zone, 3 tot 6 weken voor Mainland. Reken er niet op dat u operationeel bent zodra de vergunning binnen is: het openen van een zakelijke bankrekening is in de praktijk het echte knelpunt en kan maanden duren",
        "Kosten: let op het verschil tussen instapprijs en jaarprijs. De geadverteerde pakketprijs is doorgaans jaar 1 zonder visum, zonder kantoorsubstance en zonder audit. Verlengingen in jaar 2 liggen structureel hoger. ADGM publiceert wel transparante tarieven: niet-financiële registratie USD 5.500, verlenging USD 5.000, plus USD 300 databescherming",
...

  {
    ...
    sleutelcijfers: [
      ...
      { label: "BTW", waarde: "16%" },
      { label: "Verdrag Nederland", waarde: "Ja (2006/2007)" },
    ],
    belasting: {
      samenvatting:
        "Jordanië heeft wel degelijk een belastingverdrag met Nederland, gesloten op 30 oktober 2006 en in werking sinds 16 augustus 2007. Inkomstenbelasting is progressief maar laag. Aqaba kent een eigen, veel gunstiger regime.",
      punten: [
        "Inkomstenbelasting particulieren: 5 procent (JOD 0 tot 5.000) tot 20 procent (boven JOD 1.000.000 per jaar), effectief laag",
        "Corporate tax: 20 procent standaard. Banken: 35 procent. Telecom: 24 procent",
        "Aqaba Special Economic Zone (ASEZ): corporate tax 5 procent, geen BTW, geen import- of exportheffing. Ideaal voor handels- en logistieke bedrijven",
        "Verdrag met Nederland: gesloten 30 oktober 2006 in Den Haag, in werking getreden 16 augustus 2007 (Trb. 2007, 22). Dat beschermt tegen dubbele belasting op pensioen en dividend. Laat uw eigen situatie toetsen, want een verdrag verlaagt wel maar verhoogt nooit",
